...
The system SHALL require authentication and delegate login to the main domain (cddc39.tech).
...
- **WHEN** a user accesses the dashboard with a valid session from the main domain
