...
- [x] 1.4 List required secrets (DATABASE_URL, GOOGLE_CLIENT_ID,
      GOOGLE_CLIENT_SECRET, ENCRYPTION_KEY)
...
- [x] 3.1 Update connection configuration to use Supabase pooler format
      (port 6543)
...
- [x] 4.2 Add workflow triggers (push to main, pull_request, pull_request
      closed)
